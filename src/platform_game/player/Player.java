...
public class Player
{
	...
	try {
	    image = ImageIO.read(Background.class.getResourceAsStream("/idle__000.png"));
	} catch (Exception e) {
	    System.out.println("The player image could not be loaded, make sure that the file " + "/idle__000.png" + " exists");
	    System.exit(1);
	    e.printStackTrace();
	}
